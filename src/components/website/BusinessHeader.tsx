        ...
        <header className="sticky top-0 z-40 border-b border-[#e2f0ea] bg-white/95 backdrop-blur">
            <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6">
                        ...
                        return (
                            <Link
                                ...
                                className={cn(
                                    ...
                                    active ? "bg-[#eaf4ef] text-[#3744D2]" : "text-[#4d5d58] hover:bg-[#f4f8f5]"
                                )}
                            >
                                {item.label}
                            </Link>
                ...
                <div className="flex items-center gap-2">
                    <Link
                        href="/provider/home"
                        className="hidden items-center gap-2 rounded-xl bg-[#eaf4ef] px-4 py-2 text-sm font-bold text-[#3744D2] hover:bg-[#dceee7] sm:inline-flex"
                    >
                        Launch App
                    </Link>
                    <Link
