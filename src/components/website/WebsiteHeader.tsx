    ...
    <header className="sticky top-0 z-40 border-b border-[#e3e9e4] bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/business"
            className="hidden items-center gap-2 rounded-xl border border-[#d6dfd8] bg-white px-4 py-2 text-sm font-bold text-[#3744D2] hover:bg-gray-50 sm:inline-flex"
          >
            For Businesses
          </Link>
          <Link
            href="/auth/signup"
            className="rounded-xl bg-[#3744D2] px-4 py-2 text-sm font-bold text-white shadow-lg shadow-[#3744D2]/20 hover:scale-[1.02] transition-transform"
          >
            Get the App
          </Link>
        </div>
