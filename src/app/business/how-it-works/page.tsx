...
import { Sparkles, Store, CheckCircle2, Tablet, BellRing, Smartphone } from "lucide-react";
    ...
    return (
        <BusinessShell>
                ...
                <section className="relative overflow-hidden rounded-3xl border border-[#d6e4dc] bg-gradient-to-br from-[#eaf4ef] to-white p-8 sm:p-12">
                    ...
                    <div className="relative z-10 max-w-3xl">
                        ...
                        <h1 className="mt-4 text-4xl font-bold leading-tight text-[#1f2a2a] sm:text-5xl">
                            ...
                            <span className="text-[#3744D2]"> built to convert.</span>
                        </h1>
            ...
            <WebsiteScrollReveal delayMs={300} className="mt-12">
                <section className="rounded-3xl border border-[#3744D2]/20 bg-[#3744D2] p-8 md:p-12 text-white">
                    <div className="grid gap-12 lg:grid-cols-2 items-center">
                        ...
                        <div className="bg-white rounded-2xl border border-[#dfe5df] p-8 shadow-xl shadow-[#3744D2]/5 text-[#1f2a2a]">
