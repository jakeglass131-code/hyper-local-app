...
export default function BusinessBenefitsPage() {
    ...
    const [activities, setActivities] = useState([
        ...
        { id: 2, user: "David K.", action: "Claimed 'Gel Nails Package'", time: "12 mins ago", iconColor: "bg-emerald-100 text-emerald-600" },
        { id: 3, user: "Emma W.", action: "Redeemed '7-Day Gym Pass'", time: "28 mins ago", iconColor: "bg-teal-100 text-teal-600" },
    ]);
    ...
    useEffect(() => {
        ...
        const colors = ["bg-green-100 text-green-600", "bg-emerald-100 text-emerald-600", "bg-teal-100 text-teal-600", "bg-lime-100 text-lime-600", "bg-cyan-100 text-cyan-600", "bg-orange-100 text-orange-600"];
        ...
        <BusinessShell>
            ...
            <WebsiteScrollReveal>
                <section className="text-center py-12 relative overflow-hidden">
                    ...
                    <p className="inline-flex items-center gap-2 rounded-full bg-[#eaf4ef] px-4 py-1 text-xs font-black uppercase tracking-widest text-[#008A5E] mb-4">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black text-[#1f2a2a] tracking-tighter max-w-4xl mx-auto leading-tight">
                        ...
                        <span className="text-[#008A5E]">See the potential.</span>
                    </h1>
                ...
                <div className="grid gap-10 lg:grid-cols-2 items-center">
                    <WebsiteScrollReveal>
                        <div>
                            ...
                            <p className="text-sm font-black uppercase tracking-[0.2em] text-[#008A5E] mb-8">One metric. Clear outcome.</p>

                            <div className="rounded-[2rem] border border-[#dce7e0] bg-gradient-to-br from-[#f5fbf8] to-white p-6 sm:p-8 shadow-sm">
                                <div className="mb-8 flex items-center gap-6">
                                    <div className="relative h-28 w-28 shrink-0 rounded-full bg-[conic-gradient(#008A5E_0_270deg,#dbe1ff_270deg_360deg)] p-1">
                                        <div className="relative h-full w-full rounded-full bg-white">
                                            ...
                                            <div className="absolute left-1/2 top-1/2 h-0.5 w-10 -translate-y-1/2 origin-left bg-[#008A5E] animate-[spin_3s_linear_infinite]" />
                                        </div>
                                    </div>
                                    <div className="w-full rounded-2xl border border-[#d4e6de] bg-white p-4">
                                        ...
                                        <p className="mt-2 text-5xl font-black tracking-tight text-[#008A5E]">4.9%</p>
                                ...
                                <div className="rounded-2xl border border-gray-100 bg-white p-5">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <p className="w-20 text-[10px] font-bold uppercase tracking-wide text-[#008A5E]">HyperLocal</p>
                                            <div className="relative h-3 w-full overflow-hidden rounded-full bg-[#eaf4ef]">
                                                <div
                                                    className="relative h-full rounded-full bg-gradient-to-r from-[#008A5E] to-[#00aa7c] transition-all duration-[2200ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]"
                                                    style={{ width: isVisible ? "74%" : "0%" }}
                                                >
                                                    <span className="absolute right-0 top-1/2 h-3.5 w-3.5 -translate-y-1/2 translate-x-1/2 rounded-full border border-white bg-[#008A5E] shadow-md animate-pulse" />
                                                </div>
                                            </div>
                                            <p className="w-10 text-right text-xs font-black text-[#008A5E]">49</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <WebsiteScrollReveal delayMs={200}>
                        <div className="rounded-[2.5rem] border border-[#d6e4dc] bg-white p-8 shadow-2xl relative overflow-hidden sm:p-10">
                            <div className="absolute -right-16 -top-16 h-56 w-56 rounded-full bg-[#008A5E]/10 blur-3xl" />
                            <p className="relative z-10 text-[10px] font-black uppercase tracking-[0.3em] text-[#008A5E] mb-3">Revenue Impact</p>
                                ...
                                {idleHourRecovery.map((slot, index) => (
                                    <div key={slot.time} className="rounded-2xl border border-gray-100 bg-[#fbfcfb] p-4">
                                        <div className="mb-2 flex items-center justify-between">
                                            ...
                                            <p className="text-[11px] font-black text-[#008A5E]">+{slot.lift}%</p>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="w-14 text-[9px] font-black uppercase tracking-wide text-[#008A5E]">After</span>
                                                <div className="relative h-2.5 w-full overflow-hidden rounded-full bg-[#eaf4ef]">
                                                    <div
                                                        className="h-full rounded-full bg-gradient-to-r from-[#008A5E] to-[#00aa7c] transition-all duration-[2200ms] ease-[cubic-bezier(0.34,1.56,0.64,1)]"
                                                        style={{ width: isVisible ? `${slot.after}%` : "0%", transitionDelay: `${index * 120}ms` }}
                                                    />
                                                </div>
                                                <span className="w-8 text-right text-[10px] font-black text-[#008A5E]">{slot.after}%</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                            ...
                            <div className="relative z-10 mt-6 grid grid-cols-2 gap-3">
                                ...
                                <div className="rounded-2xl border border-[#d4e6de] bg-[#eaf4ef] p-4">
                                    <p className="text-[9px] font-black uppercase tracking-widest text-[#008A5E]">Recovered Revenue</p>
                                    <p className="mt-1 text-2xl font-black text-[#008A5E]">+$620</p>
                                    <p className="text-[10px] font-bold text-[#008A5E]/80">Average weekly lift</p>
                                </div>
                            </div>
                        </div>
                    </WebsiteScrollReveal>
            ...
            <section className="py-16 bg-[#f5fbf8] rounded-[3rem] border border-green-50 overflow-hidden relative shadow-inner">
                ...
                <div className="max-w-6xl mx-auto px-4 relative z-10">
                    <div className="grid gap-12 lg:grid-cols-2 items-center">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={card.label} className="bg-white p-8 rounded-[2rem] border border-green-100 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1">
                                        <p className="text-[10px] font-black text-[#008A5E] uppercase tracking-widest mb-1">{card.label}</p>
                        ...
                        <WebsiteScrollReveal delayMs={200}>
                            <div>
                                <h2 className="text-4xl md:text-5xl font-black text-[#1f2a2a] tracking-tight mb-6">Hyper-Local <br /><span className="text-[#008A5E]">Saturation.</span></h2>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-gray-100 group hover:border-[#008A5E]/30 transition-all cursor-default">
                                        <div className="h-10 w-10 rounded-full bg-green-50 flex items-center justify-center group-hover:bg-[#008A5E]/10 transition-colors">
                                            <MapPin className="h-5 w-5 text-[#008A5E] animate-bounce" />
                                        </div>
                                        <div>
            ...
            <section className="py-16">
                <WebsiteScrollReveal>
                    <div className="text-center mb-10">
                        <h2 className="text-4xl md:text-5xl font-black text-[#1f2a2a] tracking-tight mb-4">Real-time <span className="text-[#008A5E]">Pulse.</span></h2>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    {[
                        ...
                        <WebsiteScrollReveal key={i} delayMs={150 + (i * 100)} variant="pop">
                            <div className="p-5 rounded-[2rem] border border-gray-100 bg-white shadow-sm flex items-center gap-4 group hover:border-[#008A5E]/30 transition-all">
                                ...
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-[#008A5E] mb-0.5">{stat.label}</p>
                ...
                <WebsiteScrollReveal delayMs={300} className="mt-8">
                    <div className="rounded-[2.5rem] border border-gray-100 bg-white p-8 shadow-2xl shadow-[#008A5E]/10 relative overflow-hidden group">
                            ...
                            <div className="lg:col-span-7">
                                ...
                                <div className="h-40 flex items-end gap-2 mb-8">
                                    {liveHeights.map((h, i) => (
                                        <div
                                            key={i}
                                            className="flex-1 bg-gradient-to-t from-[#008A5E] to-[#00aa7c] rounded-full transition-all duration-[1200ms] ease-in-out origin-bottom hover:brightness-110 hover:shadow-lg relative group/bar"
                                            style={{ height: `${h}%` }}
                                        >
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-4 rounded-2xl bg-[#f5fbf8] border border-green-100 hover:bg-white transition-colors">
                                        ...
                                        <p className="text-xs font-bold text-[#008A5E] mt-0.5 tabular-nums">34 Redemptions</p>
                                    </div>
                                    <div className="p-4 rounded-2xl bg-[#f5fbf8] border border-green-100 hover:bg-white transition-colors">
                                ...
                                <div className="space-y-3 flex-1">
                                    {activities.map((act, i) => (
                                        <div key={act.id} className="flex items-center justify-between p-3.5 rounded-2xl bg-gray-50/50 border border-gray-100/50 hover:bg-white transition-all hover:shadow-md group/act cursor-default animate-in fade-in slide-in-from-bottom-2" style={{ animationDelay: `${i * 150}ms` }}>
                                            ...
                                            <div className="flex items-center gap-2">
                                                {act.time === "Just now" && <div className="h-1 w-1 rounded-full bg-[#008A5E] animate-ping" />}
            ...
            <WebsiteScrollReveal delayMs={100} className="mt-20">
                <section className="rounded-[3.5rem] bg-[#1f2a2a] p-16 text-white relative overflow-hidden mb-24 shadow-2xl">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#008A5E]/20 rounded-full blur-[140px] -mr-64 -mt-64" />
                    <div className="website-orb-slow absolute -left-40 bottom-0 h-96 w-96 rounded-full bg-[#008A5E]/15 blur-[120px]" />
                    ...
                    <div className="relative z-10 grid gap-16 lg:grid-cols-2 items-center">
                        <div>
                            ...
                            <div className="flex flex-wrap gap-5">
                                <RegisterButton className="bg-[#008A5E] text-white px-10 py-6 text-xl rounded-2xl font-black shadow-2xl shadow-[#008A5E]/50 hover:scale-105 active:scale-95 transition-all">
                                    Apply for Beta
                                </RegisterButton>
                            ...
                            {[
                                ...
                                <WebsiteScrollReveal key={perk} delayMs={200 + (i * 100)} variant="pop">
                                    <div className="flex items-center gap-5 bg-white/5 p-6 rounded-[2rem] border border-white/10 backdrop-blur-sm group hover:bg-white/15 transition-all hover:translate-x-2">
                                        <div className="h-10 w-10 rounded-full bg-[#008A5E]/20 border border-[#008A5E] flex items-center justify-center shrink-0 shadow-lg">
                                            <CheckCircle2 className="h-5 w-5 text-[#008A5E]" />
                                        </div>
            ...
            <WebsiteScrollReveal delayMs={200} className="mt-8 mb-24">
                <section className="rounded-[2.5rem] border border-[#d6e4dc] bg-[#f5fbf8] p-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="flex items-center gap-6">
                        <div className="h-20 w-20 rounded-[2rem] bg-white flex items-center justify-center text-[#008A5E] shadow-sm shrink-0 border border-[#d6e4dc]">
                    ...
                    <Link
                        href="/provider/home"
                        className="inline-flex items-center gap-3 rounded-2xl bg-[#008A5E] px-10 py-5 text-lg font-black text-white shadow-xl shadow-[#008A5E]/30 hover:scale-105 transition-transform"
                    >
                        Launch App
