    ...
    <WebsiteShell>
      <WebsiteScrollReveal>
        <section className="relative overflow-hidden rounded-[2.5rem] border border-[#dbe3db] bg-gradient-to-br from-[#f0f9f6] via-white to-[#edf5ff] p-10 sm:p-16">
          <div className="website-orb-slow absolute -right-16 -top-16 h-72 w-72 rounded-full bg-[#3744D2]/10 blur-[120px]" />
          <div className="website-orb-fast absolute -left-20 bottom-0 h-64 w-64 rounded-full bg-blue-100/30 blur-[120px]" />

          <div className="relative z-10 max-w-3xl">
            <p className="inline-flex items-center gap-2 rounded-full border border-[#d6e4dc] bg-white/95 px-4 py-1.5 text-xs font-black uppercase tracking-widest text-[#3744D2] shadow-sm mb-6">
              <Sparkles className="h-3.5 w-3.5" />
              Your New Superpower
            </p>
            <h1 className="text-5xl font-black leading-[0.9] tracking-tighter text-[#1f2a2a] sm:text-7xl">
              Savings, <br />
              <span className="text-[#3744D2]">delivered live.</span>
            </h1>
      ...
      <WebsiteScrollReveal delayMs={300} className="mt-12 mb-16" variant="pop">
        <section className="rounded-[3rem] border border-[#3744D2]/10 bg-[#3744D2] p-10 sm:p-16 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/auth/signup"
                className="inline-flex items-center gap-2 rounded-2xl bg-white px-8 py-4 text-lg font-black text-[#3744D2] shadow-2xl hover:scale-105 transition-transform"
              >
...
function FeatureCard({ icon, title, body }: { icon: React.ReactNode, title: string, body: string }) {
  return (
    <div className="rounded-[2rem] border border-gray-100 bg-white p-8 shadow-sm hover:shadow-xl transition-all group">
      <div className="h-12 w-12 rounded-2xl bg-[#3744D2]/10 text-[#3744D2] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        {icon}
      </div>
